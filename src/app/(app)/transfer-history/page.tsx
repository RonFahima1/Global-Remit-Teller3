      ...
      />
                  ...
                  <div className="space-y-3">
                    {selectedTransfer.purpose && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium">{selectedTransfer.purpose}</span>
                      </div>
                    )}
                    ...
                    {selectedTransfer.reference && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium">{selectedTransfer.reference}</span>
                      </div>
                    )}
                  </div>
                </>
              ...
              {selectedTransfer.status === 'pending' && (
                <div className="flex justify-end mt-4">
                  ...
                  >
                    {cancellingId === selectedTransfer.id ? (
                      <>
